...
import {searchStyles} from "../../assets/styles/seacrh.styles";
            ...
            <View style={searchStyles.searchSection}>
                <View style={searchStyles.searchContainer}>
                    ...
                    {searchQuery.length > 0 && (
                        <TouchableOpacity onPress={()=>setSearchQuery("")} style=
                        {searchStyles.clearButton}>
                            <Ionicons
                                name="close-circle" size={20} color={COLORS.textLight}
                            />
                        </TouchableOpacity>
                    )}
                </View>
