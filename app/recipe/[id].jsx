...
const RecipeDetailScreen=()=>{
    ...
    /*
    recipe -> tarifin detaylarını tutacak (başlangıçta null).

    loading → tarif yükleniyor mu, bunu kontrol edecek.

    isSaved → bu tarif kullanıcının favorilerinde var mı?

    isSaving → tarif favorilere eklenirken/çıkarılırken geçici durum.*/
    const {user} = useUser();
    ...
    const handleToggle= async () => {
        ...
        try {
            ...
            console.error("Error toogling recipe save: ",error);
            ...
            <ScrollView>
                <View style={recipeDetailStyles.headerContainer}>
                    ...
                    <View style={recipeDetailStyles.floatingButtons}>
                        ...
                        <TouchableOpacity
                            style={[
                                recipeDetailStyles.floatingButton,{backgroundColor: isSaving ? COLORS.gray : COLORS.primary},
                            ]}
                            onPress={handleToggle}
                            disabled={isSaving}
                        >
                            <Ionicons
                                name={isSaving ? "hourglas" : isSaved ? "bookmark":"bookmark-outline"}
                                size={24}
                                color={COLORS.white}
                            />
                        </TouchableOpacity>
